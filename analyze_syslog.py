...
# LLM model
#model = LiteLLMModel(model_id="ollama/qwen2.5", #qwen2.5 #llama3.1 num_ctx=8192)

model = LiteLLMModel(model_id="gpt-4o-mini-2024-07-18", api_key=os.getenv("OPENAI_API_KEY"))
...
host_ip = "10.10.20.48" # or use devnetsandboxiosxec9k.cisco.com
